...
public class StoreVO {
	...
	// constructor --------------------------------------------------------------------------
	public StoreVO() {}
	public StoreVO(String sIGUN_CD, String sIGUN_NM, String bIZPLC_NM, String lICENSG_DE, String lICENSG_CANCL_DE,
			String bSN_STATE_DIV_CD, String bSN_STATE_NM, String cLSBIZ_DE, String lOCPLC_FACLT_TELNO,
			String lOCPLC_AR_INFO, String rOADNM_ZIP_CD, String rEFINE_ROADNM_ADDR, String rEFINE_LOTNO_ADDR,
			String rEFINE_ZIP_CD, String rEFINE_WGS84_LAT, String rEFINE_WGS84_LOGT, String bIZCOND_DIV_NM_INFO,
			String x_CRDNT_VL, String y_CRDNT_VL, String sTOCKRS_DUTY_DIV_NM, String sFRMPROD_PROCSBIZ_DIV_NM,
			String sTOCKRS_IDNTFY_NO, String rIGHT_MAINBD_IDNTFY_NO, String tOT_EMPLY_CNT) {
		SIGUN_CD = sIGUN_CD;
		SIGUN_NM = sIGUN_NM;
		BIZPLC_NM = bIZPLC_NM;
