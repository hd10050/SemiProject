...
<div id ="wrap">
  <table style="width:960px; align:center;">
    <tr>
      <td>
      	<div id="tos_title">
    		<span style="font-size: 44px;">회원가입</span>
    	</div>
    </td>
    </tr>
            ...
            <tr>
              <td>
                <div class="tos_stitle">
                 <span style="color:#f67001; font-size:24px;">01</span> <span style="font-size: 24px;">이용약관</span>
                </div>
             </td>
           </tr>
           <tr>
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
            ...
            <tr>
              <td>
                ...
                <input type="checkbox" id="chk1">이용약관에 동의합니다.<br><br><br><br>
              </td>
            </tr>
            <tr>
              <td>
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
            ...
            <tr>
              <td>
                <input type="checkbox" id="chk2">개인정보 수집 및 이용에 대한 안내에 동의합니다.
              </td>
            </tr>
          </table>
